...
bool Image<T>::readHeader_nii() {
    ...
    case DT_UINT8:         inputDataType=UINT8;      break;
    case DT_INT8:          inputDataType=INT8;       break;
    case DT_UINT16:        inputDataType=UINT16;     break;
    case DT_INT16:         inputDataType=INT16;      break;
    case DT_UINT32:        inputDataType=UINT32;     break;
    case DT_INT32:         inputDataType=INT32;      break;
    case DT_UINT64:        inputDataType=UINT64;     break;
    case DT_INT64:         inputDataType=INT64;      break;
    case DT_FLOAT32:       inputDataType=FLOAT32;    break;
    case DT_FLOAT64:       inputDataType=FLOAT64;    break;
    case DT_FLOAT128:      inputDataType=FLOAT128;   break;
    
    case DT_COMPLEX64:
        inputDataType=COMPLEX64; 
        std::cout<<"Nifti datatype: complex64 "       << std::endl; std::cout << "is not an accepted datatype" << std::endl; 
        break;
        
    case DT_COMPLEX128:
        inputDataType=COMPLEX128; 
        std::cout<<"Nifti datatype: complex128 "      << std::endl; std::cout << "is not an accepted datatype" << std::endl; 
        break;
        
    case DT_COMPLEX256:
        inputDataType=COMPLEX256; 
        std::cout<<"Nifti datatype: complex256 "      << std::endl; std::cout << "is not an accepted datatype" << std::endl; 
        break;
        
    case DT_BINARY:
        inputDataType=UNKNOWNDATATYPE; 
