#ifndef SRC_TRACTOGRAM_PARASTREAMLINES_H_
#define SRC_TRACTOGRAM_PARASTREAMLINES_H_
...
void getParallelStreamlines(std::vector<std::vector<std::vector<float>>>& out, TractogramReader* _tractogram, float sigma, int N);
